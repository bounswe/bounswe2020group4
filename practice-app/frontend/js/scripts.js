    ...
    $.get("/vendor/nearest",
        ...
        function (response, data) {
            ...
            if(final_data !== undefined) {
                ...
                document.getElementById("vendorName").innerText = vendor + " is " + distance_final + " km away from you.";
                document.getElementById("vendorLink").setAttribute("href", "http://maps.google.com?q="+latitude+","+longitude);
            }
        })
})
