      ...
      <div className='category-title px-5 py-3' >
        ...
        <div className="sort-container">
          ...
          <div class="dropdown show">
            ...
            <a class="dropdown-item" href="#" onClick={handleDropdownClick}>Lowest Price</a>
              <a class="dropdown-item" href="#" onClick={handleDropdownClick}>Highest Price</a>
              <a class="dropdown-item" href="#" onClick={handleDropdownClick}>Best Selling</a>
              <a class="dropdown-item" href="#" onClick={handleDropdownClick}>Latest Arrival Time</a>
              <a class="dropdown-item" href="#" onClick={handleDropdownClick}>Number of Comments</a>
              <a class="dropdown-item" href="#" onClick={handleDropdownClick}>Rating</a>
              <a class="dropdown-item" href="#" onClick={handleDropdownClick}>Average Customer Review</a>
            </div>
          </div>
        </div>
      </div>
